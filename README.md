...
Les statistiques, la sélection de rooms et les six badges TryHackMe mis en avant sont regroupés dans `cyber-data.js`. Ils correspondent au profil public `SnowPeakPro` au 23 juillet 2026 : rang `[0x7][ADEPT]`, 3 102 points, 42 rooms terminées, 7 badges obtenus, classement Top 15 %, série active de 14 jours et meilleure série de 14 jours.
...
La photo de profil et les badges affichés dans la section Cyber lab sont stockés dans `assets/tryhackme/` au format WebP.
